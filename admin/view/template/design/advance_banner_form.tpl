            ...
            <tr id="image-row<?php echo $image_row; ?>">
              ...
              <td class="left"><div class="image"><img src="<?php echo $banner_image['thumb']; ?>" alt="" id="thumb<?php echo $image_row; ?>" />
               ...
               <td class="left"><select name="banner_image[<?php echo $image_row; ?>][mobile_type]"  class="form-control">
				...
				<td class="left">
				<input type="text" name="banner_image[<?php echo $image_row; ?>][name]"  item="banner_image[<?php echo $image_row; ?>][mobile_type]" itemid="banner_image[<?php echo $image_row; ?>][mobile_type_id]" class="form-control product_category" value="<?php echo $banner_image['name']; ?>">
